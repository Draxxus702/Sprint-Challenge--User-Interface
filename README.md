...
Sematic HTML is html that clearly describes its meaning to bot user and browser.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display inline does not allow for any height or width changes and block starts on a new line and takes up the whole width.
...
it allows develepors to create and share code simultaniously so they can work on seperate parts of the same project.
